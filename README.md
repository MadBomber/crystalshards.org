...
crystalshards is a new project using [Amber Framework](https://amberframework.org/)
...
```
shards build --production --release crystalshards
```
...
1. Fork it ( https://github.com/crystalshards/crystalshards.org/fork )
